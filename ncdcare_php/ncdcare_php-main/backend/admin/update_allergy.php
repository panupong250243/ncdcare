                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" style="border: 0;color:black"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="al_name" name="al_name" value="<?=$al_name;?>" required="required" class="form-control col-md-7 col-xs-12"> 
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea type="text" id="al_symptom" cols="20" rows="10" name="al_symptom"  required="required" class="form-control col-md-7 col-xs-12"><?=$al_symptom;?>"</textarea>
                                </div>
                            </div>
                        ...
                        <?php
                            if(isset($_POST['submit']))
                            {
                                ...
                                $sql=" insert into `tb_allergy`(`al_name`,`al_symptom`,`al_symptom`)";
                                $sql.=" values ('$al_name','$al_symptom','$user_id')";
                                $sql=" update tb_allergy";
                                $sql.=" set";
                                $sql.=" al_name='$al_name'";
                                $sql.=" ,al_symptom='$al_symptom'";
                                $sql.=" ,user_id='$user_id'";
                                $sql.=" where";
                                $sql.=" al_id=$al_id";
