   <!-- /page content -->
        <!-- footer content -->
        <footer  style="border: 0;background-color:#eeeeee">
          <div class="pull" style="color:#757575"><p> Copyright <i class="bi bi-c-circle"></i> 2020 Department of Disease Control-center. All rights reserved.</p></div>
